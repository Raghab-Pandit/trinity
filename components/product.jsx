...
const Product = ({id, image, name, price}) => {
  return (
    <>
        <Link href={`/products/${id}`} className='group h-60 sm:h-80 w-40 lg:w-60 shadow-[0_4px_30px_rgba(0,0,0,0.1)]'>
            <div className="h-[75%]  relative overflow-hidden border border-transparent rounded-t-[20px] bg-white/80 group-hover:bg-white transition-all duration-300 flex items-end justify-center">
            ...
            <div className="h-[25%] bg-[#1E2330] border border-transparent flex flex-col items-center rounded-b-[20px]">
